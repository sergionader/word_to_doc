...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.timesaversystems.wordtomd'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'TimeSaver Systems'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Bidirectional Word and Markdown conversion with file browsing'),
